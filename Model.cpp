...
Model :: Model()
{
    ...
    WildPokemon* W1 = new WildPokemon("Blastoise",1,2,false,1,Point2D(14,4), 'W'); //wild
    WildPokemon* W2 = new WildPokemon("Charizard",1,2,false,2,Point2D(11,9), 'W'); //wild
    LegendaryPokemon* L1 = new LegendaryPokemon("Lugia", 3, 5, false, 1, Point2D(2, 13), true, 'L');
    ...
    switch(type)
    {
        case 'c': 
        {
            for(list <PokemonCenter*> :: iterator iter1 = center_ptrs.begin(); iter1 != center_ptrs.end(); iter1++)
            {
                ...
                throw Invalid_Input("Sorry but please enter a PokemonCenter ID");
            }
