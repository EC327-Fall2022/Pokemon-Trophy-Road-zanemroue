...
void Trainer::ShowStatus(){
    ...
    case MOVING:
        ...
        break;
    case MOVING_TO_GYM:
        cout<<"Heading to PokemonGym "<<current_gym->GetId()<<" at a speed of "<<speed<<" at each step of "<<delta<<endl;//might need to change
        break;
    ...
    case RECOVERING_HEALTH:
        ...
        break;
    case FAINTED:
        cout<<name<<" has fainted you can not move!"<<endl;
        break;
    }
...
{  
    ...
    {
        cout<<name<<" is at Pokemon gym"<<endl;
        return false;
    }

    else if (state == AT_CENTER)
    {
        cout<<name<<" is at Pokemon center"<<endl;
        return false;
    }
...
void Trainer::battlingWild(int attack){
