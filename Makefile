...
OBJS = main.o Point2D.o Vector2D.o GameObject.o Building.o PokemonCenter.o PokemonGym.o Trainer.o Model.o GameCommand.o View.o WildPokemon.o LegendaryPokemon.o
...
LegendaryPokemon.o: LegendaryPokemon.cpp LegendaryPokemon.h
	$(GCC) -c LegendaryPokemon.cpp -o LegendaryPokemon.o

clean: 
	rm main Point2D.o Vector2D.o GameObject.o Building.o PokemonCenter.o PokemonGym.o Trainer.o Model.o GameCommand.o View.o WildPokemon.o LegendaryPokemon.o
